#include "../config.h"
#ifdef CONFIG_RESNET_FP32_PRECISION_TEST
...
const char* FP32_FILE = "/home/wuxy/BPVU/test_src/ResNet50/fp32_data.bin"; // 测试数据文件
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "FP32转换精度测试工具" << std::endl;
    std::cout << "=======================" << std::endl;
    ...
    std::cout << "正在进行FP32精度转换测试..." << std::endl;
